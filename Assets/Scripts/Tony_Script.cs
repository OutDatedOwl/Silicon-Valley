...
public class Tony_Script : MonoBehaviour
{
    ...
    [SerializeField]
    private Open_Sesame open_Sesame;
...
*/
    ...
    private IEnumerator Dialogue_Beep_Boop(){
        ...
        for(int i = 0; i < text_Parse_Array.Length - 1; i++){
            ...
            {
                audio_Source_Array[0].pitch = Random.Range(1.2f, 1.5f);
                audio_Source_Array[0].PlayOneShot(game_Manager.audioClipArchive[7]);
            }
        }
    }
}